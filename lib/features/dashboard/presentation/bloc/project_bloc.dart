...
import '../../domain/usecase/update_student_cubit.dart';
...
class ProjectBloc extends Bloc<ProjectEvent, ProjectState> {
  ...
  final UpdateStudentCubit _updateStudentCubit;
  ...
  ProjectBloc({
    ...
    on<UpdateStudentCubitEvent>(_onUpdateStudentCubit);
  }
